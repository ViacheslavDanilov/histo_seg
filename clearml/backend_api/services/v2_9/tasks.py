...
class Task(NonStrictDataModel):
    ...
    def hyperparams(self, value):
        ...
        value = dict(
            (k, SectionParams(**v) if isinstance(v, dict) else v) for k, v in value.items()
        )
    ...
    def configuration(self, value):
        ...
        value = dict(
            (k, ConfigurationItem(**v) if isinstance(v, dict) else v) for k, v in value.items()
        )
...
class PublishResponse(Response):
    ...
    def __init__(
        self,
        committed_versions_results=None,
        updated=None,
        fields=None,
        **kwargs,
    ):
