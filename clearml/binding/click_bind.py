try:
    from click.core import Argument, Command, Context, Group, Option  # noqa
...
class PatchClick:
    ...
    def args(cls):
        ...
        _args_type = {
            cls._section_name + '/' + k[skip:]: v for k, v in cls._args_type.items() if k[skip:]
        }
        _args_desc = {
            cls._section_name + '/' + k[skip:]: v for k, v in cls._args_desc.items() if k[skip:]
        }
