...
class PatchGradio:
    ...
    def patch_gradio(cls):
        ...
        try:
            ...
            gradio.routes.App.get_blocks = _patched_call(
                gradio.routes.App.get_blocks,
                PatchGradio._patched_get_blocks,
            )
            gradio.blocks.Blocks.launch = _patched_call(
                gradio.blocks.Blocks.launch,
                PatchGradio._patched_launch,
            )
        except Exception:
            pass
        cls.__patched = True
