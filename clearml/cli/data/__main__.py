...
def cli():
    ...
    set_description = subparsers.add_parser(
        'set-description',
        help='Set description to the dataset',
    )
    ...
    finalize = subparsers.add_parser(
        'close',
        help='Finalize and close the dataset (implies auto upload)',
    )
    ...
    publish.add_argument(
        ...
        type=str,
        required=True,
        help='The dataset task id to be published.',
    )
    ...
    rename.add_argument(
        ...
        type=str,
        required=True,
        help='The new name of the dataset(s)',
    )
    rename.add_argument(
        '--project',
        type=str,
    ...
    move.add_argument(
        ...
        type=str,
        required=True,
        help='The name of the dataset(s) to be moved',
    )
    ...
    compare.add_argument(
        ...
        type=str,
        required=True,
        help='Source dataset id (used as baseline)',
    )
    compare.add_argument(
        '--target',
        type=str,
    ...
    search = subparsers.add_parser(
        'search',
        help='Search datasets in the system (sorted by creation time)',
    )
    ...
    get = subparsers.add_parser(
        'get',
        help='Get a local copy of a dataset (default: read only cached folder)',
    )
    get.add_argument(
        '--id',
        type=str,
...
def ds_delete(args):
    if args.id:
        ...
        print(
            'Deleting dataset with project={}, name={}, version={}'.format(
                args.project,
                args.name,
                args.version,
            ),
        ...
        if args.link:
            ...
            try:
                ...
                try:
                    ...
                    raise ValueError(
                        'Target directory {} is not empty. Use --overwrite.'.format(args.link),
                    )
...
def ds_compare(args):
    print(
        'Comparing target dataset id {} with source dataset id {}'.format(args.target, args.source),
    )
    print_args(args)
    ...
    if ds.is_dirty():
        ...
        print(
            'Pending uploads, starting dataset upload to {}'.format(
                args.storage or ds.get_default_storage(),
            ),
        )
        ds.upload(
            show_progress=True,
...
def ds_publish(args):
    ...
    if not ds.is_final():
        raise ValueError(
            'Cannot publish dataset. Please finalize it first, run `clearml-data close`',
        )
...
def ds_sync(args):
    ...
    print(
        'Sync completed: {} files removed, {} added, {} modified'.format(removed, added, modified),
    )
